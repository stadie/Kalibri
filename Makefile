...
JetMETObjects:
	@cvs -d :pserver:anonymous@cmscvs.cern.ch:/cvs_server/repositories/CMSSW co -r V03-01-25 -d JetMETObjects CMSSW/CondFormats/JetMETObjects
