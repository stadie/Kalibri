...
//
//    $Id: CorFactors.h,v 1.5 2010/09/30 16:53:33 stadie Exp $
//   
#ifndef CORFACTORS_H
#define CORFACTORS_H
...
{
 public :
  CorFactors(float L1=1.0, float L2=1.0, float L3=1.0, float L4=1.0, 
	     float L5=1.0, float JPT=1.0, float JPTL2L3=1.0) 
  ...
  float getToL4() const { return getToL3()*l4_; }   //!< Return factor needed to get L4 corrected from raw jets: L1*L2*L3*L4
