...
BasePlotExtractor::BasePlotExtractor(TString plotsnames,TString kalibriPlotsShortName) {
  ...
  ExternalConfig_=ConfigFile("/afs/naf.desy.de/user/k/kriheine/scratch/Kalibri/L2andJERScripts/ExternalConfigs.cfg");
...
void BasePlotExtractor::readInExtraInfo() {
  ...
  sqrtS_ = ExternalConfig_.read<int>((std::string)kalibriPlotsShortName_+" SqrtS",ExternalConfig_.read<int>("Default SqrtS",8));
