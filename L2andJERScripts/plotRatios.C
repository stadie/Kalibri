...
TCanvas* plotRatios(std::vector<TH1D*> numeratorHistograms, TH1D* denominatorHist, TString title="", TString xTitle="", TString yTitle="") {
  ...
  TString yTitle2 = "C_{X}/C_{base}"; // bottom plot y axis title
...
//
  ...
  hist_over_denomHist[0]->GetYaxis()->SetRangeUser(0.95,1.15);
...
//  denominatorHistogram->GetYaxis()->SetRangeUser(0.95,1.25);
...
TCanvas* plotRatios(TH1D* numeratorHist, TH1D* denominatorHist, TString title="", TString xTitle="", TString yTitle="") {  
...
TCanvas* plotRatios(TH1D* numeratorHist1, TH1D* numeratorHist2, TH1D* denominatorHist, TString title="", TString xTitle="", TString yTitle="") {
  std::vector<TH1D*> numeratorHistograms;
...
TCanvas* plotRatios(TH1D* numeratorHist1, TH1D* numeratorHist2, TH1D* numeratorHist3, TH1D* denominatorHist, TString title="", TString xTitle="", TString yTitle="") {
  std::vector<TH1D*> numeratorHistograms;
  numeratorHistograms.push_back( numeratorHist1 );
  numeratorHistograms.push_back( numeratorHist2 );
