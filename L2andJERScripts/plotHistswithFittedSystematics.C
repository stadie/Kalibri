/*************************************************
  ...
  Example use (first step is to prevent a bug in ROOT crashing):
   root [1] .O0
   root [2] .L plotHistswithFittedSystematics.C
   root [3] plotHistswithFittedSystematics(photonEt_BarrelPIDcut,photonEt_Barrel,"Photon E_{T}","E_{T} (GeV)","entries/20 GeV bin")  
...
TCanvas* plotHistswithFittedSystematics(std::vector<TF1*> fit_func_list, TH1D* baseHist, TString title="", TString xTitle="", TString yTitle="", TH1D* pt_uncertainty_band=0) {
