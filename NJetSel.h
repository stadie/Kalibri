...
public :
   ...
   Int_t           NobjGenJet;
   Float_t         GenJetColPt[30];   //[NobjGenJet]
   Float_t         GenJetColPhi[30];   //[NobjGenJet]
   Float_t         GenJetColEta[30];   //[NobjGenJet]
   Float_t         GenJetColEt[30];   //[NobjGenJet]
   Float_t         GenJetColE[30];   //[NobjGenJet]
   Int_t           GenJetColJetIdx[30];   //[NobjGenJet]
