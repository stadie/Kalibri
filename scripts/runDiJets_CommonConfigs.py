...
def determineDataDir(DATAYEAR,DATATYPE):
	...
	if(DATATYPE=="2012ABCD_208686"):
            datadir = "/scratch/hh/dust/naf/cms/user/rathjd/Calibration/Winter2012_Jets_v1"    
    if(DATAYEAR == "MC2012"):
