...
"""
    ...
    plot_list=['AbsMPFVsPtAve','MPFVsPtAve','MPFJERVsAsymmJERCorrelation','MPFJERVsSE_RRJERCorrelation']
...
#    for index_samples, samples in enumerate(samples_all):
    for index_cut, cut in enumerate(cut_list):
        ...
        fcfg.write(plot_list[0] + cut + " y variable        =  MPFResponse\n")
        fcfg.write(plot_list[0] + cut + " y edges           =  101 0.50 1.50 0.5 1.5 0.5 1.5 0.5 1.5\n")
        ...
        fcfg.write(plot_list[0] + cut + " profile types     =  Mean; GaussFitMean; IQMean\n")
        ...
        fcfg.write(plot_list[1] + cut + " y variable        =  MPFResponse\n")
        fcfg.write(plot_list[1] + cut + " y edges           =  101 0.50 1.50 0.5 1.5 0.5 1.5 0.5 1.5\n")
        fcfg.write(plot_list[1] + cut + " bin variable      =  Eta\n")
        fcfg.write(plot_list[1] + cut + " bin edges         =  " + binning_values + "\n")
        ...
        fcfg.write(plot_list[1] + cut + " profile types     =  Mean; GaussFitMean; IQMean\n")
        ...
        fcfg.write(plot_list[2] + cut + " correction types  =  L2L3\n")
        fcfg.write(plot_list[2] + cut + " 1 correction types  =  L2L3\n")
        fcfg.write(plot_list[2] + cut + " profile types     =  Mean; GaussFitMean; IQMean\n")
        ...
        fcfg.write(plot_list[3] + cut + " correction types  =  L2L3\n")
        fcfg.write(plot_list[3] + cut + " 1 correction types  =  L2L3\n")
        fcfg.write(plot_list[3] + cut + " profile types     =  Mean; GaussFitMean; IQMean\n")
        fcfg.write(plot_list[3] + cut + " input samples     =  0:data;1:MC\n\n")
	
#    fcfg.write("\n")
#    config_2="""
        config_2="""
##place for more (easy) plots
...
##################################
DIR_JETALGO="MinimalJERCorrelations"
##################################
